...
enum vkd3d_expect_assume_codes
{
    VKD3D_EXPECT_ASSUME_UNKNOWN = 0,
    VKD3D_EXPECT_ASSUME_QUAD_UNIFORM = 1234000001,
    VKD3D_EXPECT_ASSUME_MESH_VERTEX_OVERFLOW = 1234000002,
    VKD3D_EXPECT_ASSUME_MESH_PRIM_OVERFLOW = 1234000003,
    VKD3D_EXPECT_ASSUME_SAMPLER_HEAP_OOB = 1234000004,
    VKD3D_EXPECT_ASSUME_RESOURCE_HEAP_OOB = 1234000005,
    VKD3D_EXPECT_ASSUME_MISSED_NURI = 1234000006,
    VKD3D_EXPECT_ASSUME_ROOT_CBV_OOB = 1234000007,
    VKD3D_EXPECT_ASSUME_GROUP_SHARED_GEP_OOB = 1234000008,
    VKD3D_EXPECT_ASSUME_CONSTANT_GEP_OOB = 1234000009,
    VKD3D_EXPECT_ASSUME_ALLOCA_GEP_OOB = 1234000010,
    VKD3D_EXPECT_ASSUME_QUESTIONABLE_BAB_OVERFLOW = 1234000011,
    VKD3D_EXPECT_ASSUME_QUESTIONABLE_STRUCTURED_OVERFLOW = 1234000012,
    VKD3D_EXPECT_ASSUME_UDIV_BY_ZERO = 1234000013,
    VKD3D_EXPECT_ASSUME_UMOD_BY_ZERO = 1234000014,
    VKD3D_EXPECT_ASSUME_SDIV_BY_ZERO = 1234000015,
    VKD3D_EXPECT_ASSUME_SREM_BY_ZERO = 1234000016,
};
