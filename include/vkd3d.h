...
#define VKD3D_CONFIG_FLAG_HUGE_NV_DGC_BUFFERS (1ull << 38)
...
#define VKD3D_CONFIG_FLAG_RETAIN_DESCRIPTOR_HEAPS (1ull << 46)
...
#define VKD3D_CONFIG_FLAG_NO_NVX (1ull << 54)
...
#define VKD3D_CONFIG_FLAG_DESCRIPTOR_HEAP (1ull << 63)
