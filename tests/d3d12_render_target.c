...
#include "shaders/render_target/headers/unbound_rtv.h"
    ...
    init_pipeline_state_desc(&pso_desc, context.root_signature, 0, NULL, &unbound_rtv_dxbc, NULL);
...
#include "shaders/render_target/headers/unknown_rtv_format.h"
    ...
    init_pipeline_state_desc(&pso_desc, context.root_signature, 0, NULL, &unknown_rtv_format_dxbc, NULL);
...
#include "shaders/render_target/headers/unknown_dsv_format.h"
    ...
    init_pipeline_state_desc(&pso_desc, context.root_signature, desc.rt_format, NULL, &unknown_dsv_format_dxbc, NULL);
    pso_desc.DSVFormat = DXGI_FORMAT_UNKNOWN;
    pso_desc.DepthStencilState.DepthEnable = true;
    pso_desc.DepthStencilState.DepthWriteMask = D3D12_DEPTH_WRITE_MASK_ZERO;
...
#include "shaders/render_target/headers/depth_stencil_test_no_dsv.h"
    ...
    init_pipeline_state_desc(&pso_desc, context.root_signature, desc.rt_format, NULL, &depth_stencil_test_no_dsv_dxbc, NULL);
    pso_desc.DSVFormat = DXGI_FORMAT_D32_FLOAT;
    pso_desc.DepthStencilState.DepthEnable = true;
    pso_desc.DepthStencilState.DepthWriteMask = D3D12_DEPTH_WRITE_MASK_ALL;
...
#include "shaders/render_target/headers/render_a8.h"

    memset(&desc, 0, sizeof(desc));
    desc.rt_format = DXGI_FORMAT_A8_UNORM;
    desc.ps = &render_a8_dxbc;
    if (!init_test_context(&context, &desc))
        return;
    command_list = context.list;
    queue = context.queue;
...
#include "shaders/render_target/headers/multisample_rendering.h"
#include "shaders/render_target/headers/multisample_rendering_resolve.h"
    ...
    init_pipeline_state_desc(&pso_desc, context.root_signature,
            context.render_target_desc.Format, NULL, &multisample_rendering_resolve_dxbc, NULL);
    hr = ID3D12Device_CreateGraphicsPipelineState(context.device, &pso_desc,
            &IID_ID3D12PipelineState, (void **)&context.pipeline_state);
    ok(hr == S_OK, "Failed to create pipeline, hr %#x.\n", hr);

    pso_desc.PS = multisample_rendering_dxbc;
...
#include "shaders/render_target/headers/rendering_no_attachments_layers_vs.h"
#include "shaders/render_target/headers/rendering_no_attachments_layers_ps.h"
    ...
    init_pipeline_state_desc(&pso_desc, context.root_signature, DXGI_FORMAT_UNKNOWN,
            &rendering_no_attachments_layers_vs_dxbc,
            &rendering_no_attachments_layers_ps_dxbc, NULL);
...
#include "shaders/render_target/headers/renderpass_rendering.h"
    ...
    init_pipeline_state_desc(&pso_desc, root_signature, 0, NULL, &renderpass_rendering_dxbc, NULL);
