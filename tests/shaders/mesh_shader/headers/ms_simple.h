static const BYTE ms_simple_code_dxil[] =
{
...
#endif
UNUSED_ARRAY_ATTR static const D3D12_SHADER_BYTECODE ms_simple_dxil = { ms_simple_code_dxil, sizeof(ms_simple_code_dxil) };
