static const DWORD ps_depth_stencil_layout_code_dxbc[] =
{
...
#endif
UNUSED_ARRAY_ATTR static const D3D12_SHADER_BYTECODE ps_depth_stencil_layout_dxbc = { ps_depth_stencil_layout_code_dxbc, sizeof(ps_depth_stencil_layout_code_dxbc) };
