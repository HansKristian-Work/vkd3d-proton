static const DWORD unaligned_vertex_stride_ps_code_dxbc[] =
{
...
#endif
UNUSED_ARRAY_ATTR static const D3D12_SHADER_BYTECODE unaligned_vertex_stride_ps_dxbc = { unaligned_vertex_stride_ps_code_dxbc, sizeof(unaligned_vertex_stride_ps_code_dxbc) };
