static const DWORD vbv_stride_edge_cases_code_dxbc[] =
{
...
#endif
UNUSED_ARRAY_ATTR static const D3D12_SHADER_BYTECODE vbv_stride_edge_cases_dxbc = { vbv_stride_edge_cases_code_dxbc, sizeof(vbv_stride_edge_cases_code_dxbc) };
