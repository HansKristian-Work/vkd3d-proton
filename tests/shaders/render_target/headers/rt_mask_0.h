static const DWORD rt_mask_0_code_dxbc[] =
{
...
#endif
UNUSED_ARRAY_ATTR static const D3D12_SHADER_BYTECODE rt_mask_0_dxbc = { rt_mask_0_code_dxbc, sizeof(rt_mask_0_code_dxbc) };
