static const DWORD depth_stencil_test_no_dsv_code_dxbc[] =
{
...
#endif
UNUSED_ARRAY_ATTR static const D3D12_SHADER_BYTECODE depth_stencil_test_no_dsv_dxbc = { depth_stencil_test_no_dsv_code_dxbc, sizeof(depth_stencil_test_no_dsv_code_dxbc) };
