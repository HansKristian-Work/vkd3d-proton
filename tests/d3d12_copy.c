...
void test_copy_batch(void)
{
    ...
    /* Test CopyResource vs CopyTextureRegion hazards */
    {
        ...
        /* Hazard */
        ID3D12GraphicsCommandList_CopyResource(context.list, committed_textures[0], committed_textures[1]);
        /* Hazard */
        ID3D12GraphicsCommandList_CopyTextureRegion(context.list, &dst, 0, 0, 0, &src, NULL);
    }

    {
        ...
        /* Hazard */
        ID3D12GraphicsCommandList_CopyResource(context.list, placed_textures[0], placed_textures[1]);
        /* Hazard */
        ID3D12GraphicsCommandList_CopyTextureRegion(context.list, &dst, 0, 0, 0, &src, NULL);
    }
