...
decl_test(test_fence_signal_ordering_raced_signal);
decl_test(test_fence_signal_ordering_raced_signal_shared);
...
decl_test(test_suballocate_va_alignment);
...
decl_test(test_vkd3d_out_of_band_interop);
...
decl_test(test_custom_border_color_limits_compute);
...
decl_test(test_raytracing_batch_dst_aliasing_shared_scratch);
decl_test(test_raytracing_batch_dst_aliasing_distinct_scratch);
