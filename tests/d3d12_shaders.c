...
#include "shaders/shaders/headers/cs_fp16_arith_denorm.h"
#include "shaders/shaders/headers/cs_fptrunc_f32_to_f16_add.h"
#include "shaders/shaders/headers/cs_fptrunc_f32_to_f16.h"
...
#include "shaders/shaders/headers/cs_udiv.h"
    ...
    struct test tests[] =
    {
        ...
        {&cs_fptrunc_roundtrip_precise_dxil, { 2048.5f, 2050.5f, 2052.0f, 2054.0f }, { 0x45000000, 0x45002000, 0x45004000, 0x45006000 }, true, false },
        /* Arithmetic is RTE. */
...
static void test_instruction_msad(bool use_dxil)
{
    D3D12_ROOT_SIGNATURE_DESC rs_desc;
...
#include "shaders/shaders/headers/cs_msad.h"
    ...
    create_root_signature(context.device, &rs_desc, &context.root_signature);
    context.pipeline_state = create_compute_pipeline_state(context.device, context.root_signature, use_dxil ? cs_msad_dxil : cs_msad_dxbc);
...
void test_instruction_msad_dxbc()
{
    test_instruction_msad(false);
}

void test_instruction_msad_dxil()
{
    test_instruction_msad(true);
}
