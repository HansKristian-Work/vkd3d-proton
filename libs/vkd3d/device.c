...
static const struct vkd3d_instance_application_meta application_override[] = {
    ...
    /* Dead Space (2023) (1693980). Expects CachedPSO to not fail with mismatch driver it seems ... */
    { VKD3D_STRING_COMPARE_EXACT, "Dead Space.exe", VKD3D_CONFIG_FLAG_PIPELINE_LIBRARY_IGNORE_MISMATCH_DRIVER, 0 },
