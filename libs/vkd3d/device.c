...
static const struct vkd3d_instance_application_meta application_override[] = {
    ...
    { VKD3D_STRING_COMPARE_HASH_EQUAL, "c1653d0b832686a2",
            VKD3D_CONFIG_FLAG_FORCE_CLEAR_UAV_COMPUTE_BARRIER |
            VKD3D_CONFIG_FLAG_DISABLE_INTERNAL_SWAPCHAIN_LATENCY_HANDLE, 0 },
