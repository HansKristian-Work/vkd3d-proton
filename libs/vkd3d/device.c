...
static const struct vkd3d_instance_application_meta application_override[] = {
    ...
    /* Guardians of the Galaxy: Tries to use root descriptors with indirect rendering and fails to initialize placed resources. */
    { VKD3D_STRING_COMPARE_EXACT, "gotg.exe", VKD3D_CONFIG_FLAG_FORCE_RAW_VA_CBV | VKD3D_CONFIG_FLAG_FORCE_INITIAL_TRANSITION, 0 },
