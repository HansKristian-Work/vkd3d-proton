...
/* VK_KHR_ray_tracing */
VK_DEVICE_EXT_PFN(vkBindAccelerationStructureMemoryKHR)
VK_DEVICE_EXT_PFN(vkBuildAccelerationStructureKHR)
VK_DEVICE_EXT_PFN(vkCmdBuildAccelerationStructureIndirectKHR)
VK_DEVICE_EXT_PFN(vkCmdBuildAccelerationStructureKHR)
VK_DEVICE_EXT_PFN(vkCmdCopyAccelerationStructureKHR)
VK_DEVICE_EXT_PFN(vkCmdCopyAccelerationStructureToMemoryKHR)
VK_DEVICE_EXT_PFN(vkCmdCopyMemoryToAccelerationStructureKHR)
...
VK_DEVICE_EXT_PFN(vkCopyAccelerationStructureKHR)
VK_DEVICE_EXT_PFN(vkCopyAccelerationStructureToMemoryKHR)
VK_DEVICE_EXT_PFN(vkDestroyAccelerationStructureKHR)
VK_DEVICE_EXT_PFN(vkGetAccelerationStructureDeviceAddressKHR)
VK_DEVICE_EXT_PFN(vkGetAccelerationStructureMemoryRequirementsKHR)
VK_DEVICE_EXT_PFN(vkGetDeviceAccelerationStructureCompatibilityKHR)
VK_DEVICE_EXT_PFN(vkGetRayTracingCaptureReplayShaderGroupHandlesKHR)
VK_DEVICE_EXT_PFN(vkGetRayTracingShaderGroupHandlesKHR)
VK_DEVICE_EXT_PFN(vkWriteAccelerationStructuresPropertiesKHR)
