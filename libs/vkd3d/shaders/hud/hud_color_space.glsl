...
layout(constant_id = 1) const uint c_color_space = VK_COLOR_SPACE_SRGB_NONLINEAR_KHR;
...
bool vk_format_is_srgb(uint format)
{
...
{
    switch (c_color_space)
    {
        case VK_COLOR_SPACE_SRGB_NONLINEAR_KHR:
            if (!vk_format_is_srgb(c_format))
