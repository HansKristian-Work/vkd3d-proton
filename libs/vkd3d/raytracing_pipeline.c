        ...
        struct d3d12_rt_state_object_pipeline_data *data)
{
    ...
    if (object->pipeline_config.Flags & D3D12_RAYTRACING_PIPELINE_FLAG_ALLOW_OPACITY_MICROMAPS)
        pipeline_create_info.flags |= VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR;

    pipeline_create_info.flags |=
            vkd3d_atomic_uint32_load_explicit(&object->device->global_ray_tracing_pipeline_create_flags,
